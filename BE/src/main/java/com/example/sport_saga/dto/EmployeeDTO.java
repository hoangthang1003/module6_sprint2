...
import com.example.sport_saga.modal.Position;
...
public class EmployeeDTO implements Validator {
    ...
    public EmployeeDTO(Integer idEmployee, Boolean gender, LocalDate dateOfBirth, double salary, String image, String nameEmployee, String address, String phoneNumber, String email, Position position, AccountUser account) {
